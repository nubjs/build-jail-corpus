...
export const remediationFor = (code) => ({
  ...
  NUB_MANIFEST_PARSE_DEFECT: { priority: 'P1', disposition: 'nub-fix', experiment: 'accept duplicate manifest keys with npm-compatible last-value semantics before comparing lifecycle behavior' },
